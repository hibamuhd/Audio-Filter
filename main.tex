...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11026 - Hiba Muhammed $^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/audio.wav
\end{lstlisting}
...
There are a lot of yellow lines between 440 Hz to 6KHz.  These represent the synthesizer key tones. Also, the key strokes are audible along with background noise.\\
\begin{figure}[H]
	\centering
    \includegraphics[width=\columnwidth]{figs/audio1.png }
...
\begin{figure}[H]
	\centering
    \includegraphics[width=\columnwidth]{figs/audio2.png }
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/3.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/3.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/5.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/hndef.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/6.123.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/6.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/6.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/7.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{1.97}y(n - 1) + \brak{1.7}y(n - 2) \nonumber \\
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/hibamuhd/Audio-Filter/blob/main/codes/filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
